    ...
    <div class="outer buttons_page">
        <div class="inner bg-container">
            <div class="card">
                <div class="card-block">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="row">
                                <div class="col-xs-12 col-lg-6 m-t-35 buttons_center">
                                    <h5>Basic Buttons</h5>
                                    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-lg-6">
                                <div class="button_section_align">
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4 col-lg-6 col-md-4 col-sm-6 col-xs-12 m-t-10">
                                            <div class="dropdown">
            ...
            <div class="card button_parent_section m-t-35">
                <div class="card-block">
                    <div class="row">
                        <div class="col-xs-12 col-lg-6 button_section_align">
                            <h5>Button Wrapper</h5>
                            <div class="flatbuttons text-xs-center flatbuttons_button_wrapper">
                                <div class="buttons_page_alignment">
                                    <div class="col-xl-5  col-xs-12 button_align_top">
                                                    <span class="button-wrap">
                                                        <a href="#"
                                                           class="button button-circle button-primary button-wrapper">Button</a>
                                                    </span>
                                    </div>
                                    <div class="col-xl-5 col-xs-12 button_align_top_button_wrap">
                                                    <span class="button-wrap">
                            ...
                            <div class="buttongroup">
                                <div class="row m-t-10">
                                    ...
                                    <div class="col-xl-4 col-lg-12 col-sm-4">
                                        <div class="row">
                                            <div class="col-lg-12 col-md-4 col-sm-2 col-xs-6">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="row">
                                <div class="col-xs-12 button_section_align">
                                    <h5>Social Buttons</h5>
                                    <div class="row list-group social_dashboard_margin_top">
