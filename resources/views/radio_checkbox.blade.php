                            ...
                            <form class="form-horizontal">
                                <div class="row">
                                    <div class="custom-controls-stacked">
                                        <div class="col-xs-12 col-md-6 m-t-35">
                            ...
                            <div class="row">
                                    ...
                                    <form class="form-horizontal">
                                        ...
                                        <div class="left_align">
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" data-on-text="1" data-off-text="0" type="checkbox" data-size="mini" checked>
                                            </div>
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" data-on-text="YES" data-off-text="NO" type="checkbox" data-size="small" >
                                            </div>
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" data-on-text="YES" data-off-text="NO" type="checkbox" checked>
                                            </div>
                                            <div class="form-group">
                                                <input class="make-switch" data-on-text="TRUE" data-off-text="FALSE" type="checkbox" data-size="normal" checked>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-md-6 m-t-35">
                                    <form class="form-horizontal">
                                        ...
                                        <div class="left_align">
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" type="checkbox" data-on-text="1" data-off-text="0" data-on-color="info" data-off-color="success" checked>
                                            </div>
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" type="checkbox" data-on-color="danger" data-off-color="warning">
                                            </div>
                                            <div class="form-group radio_basic_swithes_padbott">
                                                <input class="make-switch" type="checkbox" data-on-color="success" data-off-color="danger" checked>
                                            </div>
                                            <div class="form-group">
                                                <input class="make-switch" type="checkbox" data-on-text="YES" data-off-text="NO" data-on-color="primary" data-off-color="default" checked>
                                            </div>
                                        </div>
                                    </form>
                                </div>
