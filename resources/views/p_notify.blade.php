                            ...
                            <div class="row opacity">
                                <div class="col-lg-12 m-t-35">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-6 col-xs-12 m-t-20">
                                            ...
                                            <!--<div class="form-group">-->
                                            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-7 col-xs-12 m-t-20">
                            ...
                            <div class="row">
                                <div class="col-lg-12 m-t-35">
                                    ...
                                    <div class="row opacity">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
                                            <button class="btn btn-mint source notify_callback1">Notice-Error to Success-Info
                                            </button>
                                        </div>
                                        <div class="col-xl-3 col-lg-4 col-sm-6">
